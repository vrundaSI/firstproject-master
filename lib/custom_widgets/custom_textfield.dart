...
class CustomTextField extends StatelessWidget {
  ...
  const CustomTextField({Key key, this.keyboardType, this.validator, this.obSecure, this.hintText, this.controller, this.title, this.isValue,  this.isRadius}) : super(key: key);
